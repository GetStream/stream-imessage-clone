...
class MessageListViewController: ChannelsViewController {
    ...
    override func dequeueChannelCell(at indexPath: IndexPath) -> ChannelTableViewCell {
        tableView.dequeueReusableCell(withIdentifier: MessageListCell.reuseIdentifier) as! MessageListCell
    }
    
    override func channelCell(at indexPath: IndexPath, channelPresenter: ChannelPresenter) -> UITableViewCell {
        let cell = super.channelCell(at: indexPath, channelPresenter: channelPresenter) as! MessageListCell
